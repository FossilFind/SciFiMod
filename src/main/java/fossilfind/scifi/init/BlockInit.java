...
public class BlockInit
{
	...
	public static final RegistryObject<Block> IRON_FRAME = BLOCKS.register("iron_frame", () -> new Block(Block.Properties.from(Blocks.IRON_BLOCK).notSolid()));
	public static final RegistryObject<Block> TITANIUM_FRAME = BLOCKS.register("titanium_frame", () -> new Block(Block.Properties.from(Blocks.IRON_BLOCK).notSolid()));
