...
public class BlockInit
{
	...
	public static final RegistryObject<Block> TANTULUM_BLOCK = BLOCKS.register("tantalum_block", () -> new Block(Block.Properties.from(Blocks.IRON_BLOCK)));
	public static final RegistryObject<Block> TANTULUM_CARBIDE_BLOCK = BLOCKS.register("tantalum_carbide_block", () -> new Block(Block.Properties.from(Blocks.IRON_BLOCK)));
	...
	public static final RegistryObject<Block> TANTULUM_FRAME = BLOCKS.register("tantalum_frame", () -> new Block(Block.Properties.from(ALUMINUM_FRAME.get())));
	public static final RegistryObject<Block> TANTULUM_CARBIDE_FRAME = BLOCKS.register("tantalum_carbide_frame", () -> new Block(Block.Properties.from(ALUMINUM_FRAME.get())));
