...
public class FluidInit
{
	...
	public static final RegistryObject<FlowingFluid> SEAWATER = FLUIDS.register("seawater_still", () ->  new ForgeFlowingFluid.Source(FluidInit.SEAWATER_PROPERTIES));
	...
	public static final RegistryObject<FlowingFluid> HYDROGEN = FLUIDS.register("hydrogen_still", () -> new ForgeFlowingFluid.Source(FluidInit.HYDROGEN_PROPERTIES));
	...
	public static final RegistryObject<FlowingFluid> OXYGEN = FLUIDS.register("oxygen_still", () -> new ForgeFlowingFluid.Source(FluidInit.OXYGEN_PROPERTIES));
	...
	public static final RegistryObject<FlowingFluid> CHLORINE = FLUIDS.register("chlorine_still", () -> new ForgeFlowingFluid.Source(FluidInit.CHLORINE_PROPERTIES));
	...
	public static final RegistryObject<FlowingFluid> STEAM = FLUIDS.register("steam_still", () -> new ForgeFlowingFluid.Source(FluidInit.STEAM_PROPERTIES));
