...
public class MoonChunkGenerator extends NoiseChunkGenerator<MoonGenerationSettings>
{
	...
	public MoonChunkGenerator(IWorld world, BiomeProvider provider, MoonGenerationSettings settings)
	{
		super(world, provider, 4, 8, 256, settings, true);
		randomSeed.skip(2620);
		depthNoise = new OctavesNoiseGenerator(this.randomSeed, 15, 0);
		isAmplified = world.getWorldInfo().getGenerator() == WorldType.AMPLIFIED;
	}
	
	@Override
	protected void fillNoiseColumn(double[] noiseColumn, int noiseX, int noiseZ)
	{
		calcNoiseColumn(noiseColumn, noiseX, noiseZ, (double) 684.412F, (double) 684.412F, 8.555149841308594D, 4.277574920654297D, 3, -10);
	}
